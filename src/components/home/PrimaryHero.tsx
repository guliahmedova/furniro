  ...
  return (
    <section className='bg-primary-hero-image h-screen w-full bg-fixed bg-center bg-no-repeat bg-cover md:bg-top font-Poppins'>
      <div className="h-screen w-full flex lg:justify-end items-center lg:px-[58px] justify-center px-3">
        <div className="lg:w-5/12 bg-[#FFF3E3] border-r-8 shadow-sm pt-[62px] lg:mt-[153px] pb-[37px] lg:px-9 px-3 md:min-w-min">
          <span className="text-[1rem] font-medium tracking-[3px]">New Arrival</span>
          <h1 className="pt-1 lg:mb-4 lg:mt-0 text-[#B88E2F] my-5 font-bold lg:text-[52px] lg:leading-[65px] left-16 lg:w-[430px] text-lg">Discover Our New Collection</h1>
          ...
          <button className="bg-[#B88E2F] uppercase font-bold text-[1rem] lg:w-[222px] w-full py-[25px] lg:mx-0 mx-auto block cursor-pointer text-white border-0 outline-0">buy now</button>
        </div>
      </div>
    </section>
  )
