            ...
            <div className="max-w-[1240px] mx-auto pt-[72px] pb-[85px] flex gap-8 lg:flex-row flex-col lg:px-0 px-3">
                <div className='lg:block flex lg:justify-normal justify-between'>
                    <div className="bg-[#F9F1E7] flex lg:flex-row flex-col lg:justify-normal px-3 justify-between gap-6 lg:gap-28 lg:px-28 py-4 rounded-sm">
                        <span className="font-medium text-[1rem] lg:leading-6">Product</span>
                        <span className="font-medium text-[1rem] lg:leading-6">Price</span>
                        <span className="font-medium text-[1rem] lg:leading-6">Quantity</span>
                        <span className="font-medium text-[1rem] lg:leading-6">Subtotal</span>
                    </div>
                    ...
                    <div className='flex items-center lg:gap-[68px] gap-6 lg:pt-[55px] lg:flex-row lg:justify-normal flex-col justify-between'>
                        ...
                        <span className='text-[#9F9F9F] font-normal text-[1rem] lg:leading-6'>Rs. 250,000.00</span>
                        <div className='text-[#000000] border-2 rounded-lg py-1 px-3 text-[1rem] border-[#9F9F9F]'>1</div>
                        <span className='text-[#000000] text-[1rem] font-normal lg:leading-6'>Rs. 250,000.00</span>
                ...
                <div className="bg-[#F9F1E7] lg:w-[393px] rounded-sm lg:px-[75px] lg:pb-[80px] px-6 pb-6">
                    ...
                    <button className="text-[#000000] border-2 border-[#000000] py-[14px] font-normal text-[20px] leading-7 rounded-lg w-[222px] block mx-auto">Check Out</button>
                </div>
            </div>
        </section>
    )
