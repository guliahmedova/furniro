...
const AddToCartModal: FC<AddToCartModalProps> = ({ children, isModalOpen, handleCLoseBtnClick }) => {
    ...
    return (
        <div
            className={`top-0 left-0 flex justify-center items-center z-40 bg-[#3A3A3A]/60 h-screen w-full ${isModalOpen ? 'fixed' : 'hidden'}`}
            onClick={handleOutsideClick}>
            {productByIDLoading === 'pending' ? (
                ...
                <div className="bg-white rounded-sm lg:w-auto p-3 w-[95%] mx-auto" ref={modalRef}>
