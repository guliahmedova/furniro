  ...
  return (
    <Link to="/productDetail/1" className="h-full group cursor-pointer">
      <div className="relative overflow-hidden h-full">
        ...
        <span className='absolute top-[24px] right-6 w-12 h-12 rounded-full bg-[#E97171] flex items-center justify-center text-white font-medium'>-30%</span>
        ...
        <div className='p-[16px] pb-8 bg-[#F4F5F7]'>
          ...
          <p className='text-[#898989] font-medium'>Luxury big sofa</p>

          <div className='mt-[8px] flex gap-4'>
            <span className='text-[#3A3A3A] font-bold text-xl'>Rp 2.500.000</span>
            <span className='text-[#B0B0B0] font-normal leading-6 line-through'>Rp 3.500.000</span>
          </div>
        </div>
      </div>
    </Link>
