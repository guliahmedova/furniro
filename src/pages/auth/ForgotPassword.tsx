  ...
  return (
    <div className="w-[85%] mx-auto py-10">
      <section className="w-full">
        <h1 className="font-bold text-2xl text-center text-gray-600 xl:block hidden">Password</h1>
          ...
          <form className="w-full border p-5">
            ...
            <div className="flex gap-3 xl:flex-row flex-col">
              <div className="xl:w-6/12 w-full">
                <label htmlFor="newpassword" className="block capitalize font-medium text-lg my-2">new password</label>
                <input className="p-4 rounded-md focus:outline w-full focus:outline-gray-500" type="password" id="newpassword" />
              </div>
              <div className="xl:w-6/12 w-full">
                <label htmlFor="repeatpassword" className="block capitalize font-medium text-lg my-2">Repeat password</label>
